...
TEX = ED / "referee_wp_v11.tex"
PDF = ED / "referee_wp_v11.pdf"
...
BRIEF = ED / "referee_briefing_v11.md"
...
if BRIEF.exists():
    ...
    rec("G2d", "FAIL", "referee_briefing_v11.md missing")

COVER = ED / "cover_letter_v11.md"
COVER_CLAIMS = [
...
if COVER.exists():
    ...
    rec("G2b", "FAIL", "cover_letter_v11.md missing")
...
if PDF.exists():
    ...
    rec("G8", "FAIL", "referee_wp_v11.pdf missing")
...
bib = (ED / "referee_wp_v11.bib").read_text(encoding="utf-8") if (ED / "referee_wp_v11.bib").exists() else ""
