...
# ================= §E 頑健性 =================
h1("§E　頑健性の検査(本編Ⅱ章末「条件③の検証(要約)」に対応 ― 16通り検査の全表は本節が正典)")
...
para(
    ...
    "3. 図:        .venv/bin/python3 scripts/make_contest_figures_v5.py  → assets/fig2_shu_v5.png, fig3_cum_v5.png, fig2_ha_v5.png\n"
    "4. 本編:      .venv/bin/python3 scripts/build_contest_v6.py [--tocmap tocmap_v6.json]  (2パス)\n"
    "     → beyond_buffett_stockleague_v6.docx →(soffice)→ .pdf\n"
    "5. 本補遺:    .venv/bin/python3 scripts/build_appendix_v6.py  → beyond_buffett_technical_appendix_v6.docx →(soffice)→ .pdf",
    mono=True, after=4)
...
out = ED / "beyond_buffett_technical_appendix_v6.docx"
doc.save(str(out))
